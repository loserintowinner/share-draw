...
{
	if (this.ui.owncloud != null)
	{
		this.ui.confirm(mxResources.get('saveItToOwnCloudToShare', [this.getTitle()]),
			mxUtils.bind(this, function()
		{
			this.ui.pickFolder(App.MODE_OWNCLOUD, mxUtils.bind(this, function(folderId)
			{
				var graph = this.ui.editor.graph;
				var selection = graph.getSelectionCells();
				var viewState = graph.getViewState();
				...
				this.ui.createFile(this.getTitle(), this.ui.getFileData(null, null, null, null, null,
					null, null, null, this), null, App.MODE_OWNCLOUD, null, true, folderId, null, null,
					mxUtils.bind(this, function()
					{
						this.ui.restoreViewState(page, viewState, selection);
		...
		}), null, mxResources.get('saveToOwnCloud', null, 'Save to OwnCloud'), mxResources.get('cancel'));
	}
	else if (this.ui.drive != null)
	{
