...
var LinkDialog = function(editorUi, initialValue, btnLabel, fn, showPages, showNewWindowOption, linkTarget)
{
	...
	if (editorUi.yun139 != null)
	{
		addButton('yun139', function()
		{
			editorUi.yun139.pickFile(function(path)
			{
				if (path != null)
				{
					var tokens = path.split('/');
...
var Yun139AuthDialog = function(editorUi, peer, showRememberOption, fn, customButtons)
{
	var div = document.createElement('div');
	div.style.textAlign = 'center';
	...
	if (customButtons != null)
	{
		for (var i = 0; i < customButtons.length; i++)
		{
			(function(label, fn, title)
			{
				...
				customBtn.className = 'geBtn geShareBtn';
