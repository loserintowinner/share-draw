...
App.prototype.init = function()
{
	...
	/**
	 * Creates yun139 client.
	 */
	try
	{
		this.yun139 = (!mxClient.IS_IE || document.documentMode == 10 ||
			mxClient.IS_IE11 || mxClient.IS_EDGE) &&
		(urlParams['ss'] != '0' && (urlParams['embed'] != '1' ||
			urlParams['ss'] == '1')) ? new Yun139Client(this) : null;

		if (this.yun139 != null)
		{
			this.yun139.addListener('userChanged', mxUtils.bind(this, function()
			{
...
App.prototype.showYun139AuthDialog = function(peer, showRememberOption, fn, closeFn, customButtons)
{
	var resume = this.spinner.pause();

	this.showDialog(new Yun139AuthDialog(this, peer, showRememberOption, mxUtils.bind(this, function(remember)
	{
		try
		{
			if (fn != null)
	...
	}), customButtons).container, 300, 180, true, true, mxUtils.bind(this, function(cancel)
	{
		if (closeFn != null)
		{
			closeFn(cancel);
...
App.prototype.getMainUser = function()
{
	...
	else if (this.yun139 != null && this.yun139.getUser() != null)
	{
...
App.prototype.toggleUserPanel = function()
{
	...
	else
	{
		...
		if (this.yun139 != null)
		{
			addUser(this.yun139.getUser(), IMAGE_PATH + '/yun139-logo.svg', mxUtils.bind(this, function()
			{
				var file = this.getCurrentFile();
